var blue, buildDone, color, config, debug, error, fatal, green, growl, info, isDebug, isStartup, mimosaConfig, red, setConfig, setDebug, success, warn, _log, _wrap,
  __slice = [].slice;
...
success = function() {
  ...
  title = options === true ? "Success" : (mimosaConfig != null ? mimosaConfig.growl : void 0) != null ? (s = mimosaConfig.growl.onSuccess, isStartup && !mimosaConfig.growl.onStartup ? (console.log("gonna be null!"), null) : !options || (options.isJavascript && s.javascript) || (options.isCSS && s.css) || (options.isTemplate && s.template) || (options.isCopy && s.copy) ? "Success" : (console.log("gonna be null, promise!"), null)) : "Success";
